...
export default {
  ...
  computed: {
    getReqData() {
      return Object.assign({}, this.$route.params, { page: this.page });
    },
    breadCrumb() {
      ...
      if (Boolean(par.pid + par.tag + par.type) === false)
        txt += '<span style="color:#aaa"> 推荐 </span> / ';
